...
de Monstruos del mismo turno.</h4>
            ...
            <img src={`eventos/nomuertos/${eventosArray[4]}.jpg`} className="carta" onClick={() => handleClick(28,1,4)}/>
            <img src={`eventos/orcos/${eventosArray[5]}.jpg`} className="carta" onClick={() => handleClick(34,1,5)}/>
        </div>
    )
}